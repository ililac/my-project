...
<script>
	...
	export default {
		...
		methods: {
					...
					detailList({id:this.procDefId}).then(res=>{
						if(res.result == "success"){
							...
							if(res.data.contract.contentname){
								this.fileDownUrl = "/zhfw/contract/draft/download?id="+res.data.contract.id+"&tag=1&accessToken="+this.getStore("accessToken");
							}else{
								this.fileDownUrl = "";
							}
							if(res.data.contract.attachmentname){
								this.fileDownUrl2 = "/zhfw/contract/draft/download?id="+res.data.contract.id+"&tag=2&accessToken="+this.getStore("accessToken");
							}else{
								this.fileDownUrl2 = "";
							}
			...
			edit(v) {
				if(v.contentname){
					this.fileDownUrl = "/zhfw/contract/draft/download?id="+v.id+"&tag=1&accessToken="+this.getStore("accessToken");
				}else{
					this.fileDownUrl = "";
				}
				if(v.attachmentname){
					this.fileDownUrl2 = "/zhfw/contract/draft/download?id="+v.id+"&tag=2&accessToken="+this.getStore("accessToken");
				}else{
					this.fileDownUrl2 = "";
				}
				this.editClick = true;
