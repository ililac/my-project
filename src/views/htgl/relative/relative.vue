          ...
          <Row>
            <Form ref="searchForm" :model="searchForm" inline :label-width="60" class="search-form">
              <Form-item label="名称">
                <Input
                  type="text"
                  v-model="searchForm.counterpartName"
                  placeholder="请输入"
                  clearable
                  style="width: 200px"
                />
              ...
              <Form-item label="机构类型">
                <Select
                  v-model="searchForm.counterpartTypeId"
                  placeholder="请选择"
                  style="width:200px"
                >
    ...
    edit(v) {
      modelRelativeDetail({ id: v.id, type: 2 }).then(res => {
        if (res.success) {
          ...
          this.dictForm.punishmentInfos =
            res.result.punishmentInfos.punishmentInfos;
          ...
          this.dictForm.ktannouncements =
            res.result.ktannouncements.ktannouncements;
          this.dictForm.noticeTotal = res.result.ktannouncements.total;
          this.dictForm.stockholdersList =
            res.result.stockholdersList.stockholdersList;
