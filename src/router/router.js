...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'applyManage', title: '我的申请', name: 'applyManage', component: () => import('@/views/activiti/business/applyManage.vue') },
...
//     path: '/htgl/newContract',
//     meta: {
//         title: '合同起草'
//     },
//     name: '合同起草',
//     component: () => import('@/views/activiti/business/newContract.vue')
// };
